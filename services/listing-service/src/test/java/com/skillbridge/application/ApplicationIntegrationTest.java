...
class ApplicationIntegrationTest {
    ...
    void apply_activeListing_createsPendingApplication() throws Exception {
        ApplicationRequest request = new ApplicationRequest(
                "I can fix this today", activeListing.getId());
    ...
    @Test
    @DisplayName("POST /api/v1/applications/apply returns 409 for DRAFT listing")
    void apply_draftListing_returns409() throws Exception {
        ApplicationRequest request = new ApplicationRequest(
                "I can fix this today", draftListing.getId());
